...
for cluster in normalized_df['cluster'].unique():
    plt.scatter(
        normalized_df[normalized_df['cluster'] == cluster]['timestamp_sec'],
        normalized_df[normalized_df['cluster'] == cluster]['distance'],
...
plt.xlabel('Time MinMax')
plt.ylabel('Distance MinMax')
plt.title('K-means Clustering')
plt.legend(loc=(0.08,0.65))
plt.show()